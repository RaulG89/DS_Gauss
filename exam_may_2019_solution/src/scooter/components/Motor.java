...
public class Motor {
	...
	// Energía consumida en una hora, en vatios, con el motor a la máxima
	// potencia
	...
	// los distintos modos de conducción pueden modificar la velocidad máxima
	// actual
	private int maximumSpeed = MAX_SPEED;
	// un valor entre 0 y 100 que representa el porcentaje de giro del
	// acelerador
	private int acceleration;
	// velocidad actual, determinada por la velocidad máxima actual y el
	// porcentaje
	// de aceleración
	private int speed;
	...
	// -- Métodos que actúan sobre el funcionamiento del motor y que determinan
	// la
	...
	public void setMaximumSpeed(int maximumSpeed) {
		...
		if (maximumSpeed > MAX_SPEED)
			throw new IllegalArgumentException(
					"La velocidad máxima actual no puede exceder la máxima posible");
		if (maximumSpeed < 0)
			throw new IllegalArgumentException(
					"¡La velocidad máxima actual no puede ser menor que cero!");
	...
	public void accelerate(int percentage) {
		...
		if (percentage < 0 || percentage > 100)
			throw new IllegalArgumentException(
					"¡El porcentaje del acelerador debe estar entre cero y cien!");
		this.acceleration = percentage;
		updateSpeed();
	}

	// Llamado cuando se modifican o la velocidad máxima actual o la
	// aceleración:
	// en ambos casos se recalcula la velocidad actual a la que rueda el
	// patinete.
	private void updateSpeed() {
		speed = maximumSpeed * acceleration / 100;
		assert speed >= 0
				&& speed <= maximumSpeed : "La velocidad está siempre entre 0 y la velocidad máxima actual";
	}
