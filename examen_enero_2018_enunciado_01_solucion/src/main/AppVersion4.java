...
public class AppVersion4 {
	...
	public void openWindow() {
		...
		// Parte 1
		// -------
		// Mostrar sólo los móviles en una tabla (que ponga "Marca" y "Modelo"
		// en la cabecera)
		...
		// Parte 2
		// -------
		// Mostrar en una misma tabla los discos, libros y móviles (que ponga
		// "Nombre"
		// y "Propietario" en la cabecera).
		//
		// Nótese que en esta ocasión, en los móviles, el modelo debe quedar en
		// la
		 ...
		 * Dragon's Kiss | Marty Friedman | | El Código Da Vinci | Dan Brown | |
		 * Design Patterns | Erich Gamma | | Galaxy S8 | Samsung | | iPhone 8 |
		 * Apple | +--------------------+----------------+
		 */
