...
public class Database {
	public Collection<Monument> selectMonuments() {
		...
		monuments.add(new Monument("Coliseo", "Vespasiano",
				"Piazza del Colosseo, 1, 00184 Roma, Italia"));
		monuments.add(new Monument("Fontana di Trevi", "Niccolo Salvi",
				"Trevi (Piazza di), 00187 Roma, Italia"));
		return monuments;
	}

	public Collection<Photo> selectPhotos() {
		List<Photo> photos = new ArrayList<Photo>();
		photos.add(new Photo("Colosseum in Rome, Italy - April 2007",
				"DAVID ILIFF", new Coordinates(20, 20)));
		photos.add(new Photo("Fontana di Trevi", "mariocutroneo",
	...
	public Collection<Restaurant> selectRestaurants() {
		...
		restaurants.add(new Restaurant("La Taverna dei Fori Imperiali",
				...
				"+39 06 6798643"));
		restaurants.add(new Restaurant("Pane e Salame",
